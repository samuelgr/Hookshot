...
; When run in 64-bit mode, this test exercises RIP-relative addressing for performing an address generation operation.
...
; However, before loading from memory, compute the effective address using the lea instruction.
